...
import { 
    MapPin, Star, Wifi, Waves, Dumbbell, UtensilsCrossed, Car, Wine, 
    BedDouble, Users, Baby, Clock, ChevronLeft, ChevronRight, Moon, Shield,
    Coffee
} from 'lucide-react';
...
import { hotelService } from '../services/hotel.service'; // ── NEW: Secure Axios Service
...
const AMENITY_ICONS: Record<string, any> = {
    ...
    Restaurant: UtensilsCrossed, Valet: Car, Bar: Wine, Spa: Coffee, Parking: Car
};
...
export const HotelDetailPage = () => {
    ...
    // Shared element layoutId passed from SearchPage for morphing transition
    const hotelLayoutId = (location.state as any)?.hotelLayoutId;
    ...
    useEffect(() => {
        const fetchHotel = async () => {
            ...
            try {
                ...
                const actualHotel = response.data || response;
    ...
    const handleBook = () => {
        if (!isAuthenticated || !user) { 
            navigate('/login', { state: { message: 'Please log in to reserve this sanctuary.' } }); 
            return; 
        }
    ...
    if (!hotel) return (
        <div className="min-h-screen pt-24 flex items-center justify-center text-gray-500 font-bold text-xl">Hotel not found.</div>
    );
    ...
    // Booking payload passed into the Checkout Drawer
    ...
    return (
        <>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full pb-20 pt-24 max-w-7xl mx-auto px-4 md:px-8">
                <button onClick={() => navigate('/search')} className="flex items-center gap-2 text-gray-500 hover:text-[var(--tm-ethereal-purple)] font-bold mb-8 transition-colors group">
                ...
                <div className="grid lg:grid-cols-5 gap-10">
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        <GlassCard className="p-0 overflow-hidden rounded-3xl shadow-2xl border-gray-100">
                            <motion.div layoutId={hotelLayoutId} className="relative h-80 md:h-[480px] bg-gray-100 group">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 font-medium leading-relaxed text-lg mb-8 whitespace-pre-line">{hotel.description}</p>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {hotel.amenities.map((am: string) => {
                                            const Icon = AMENITY_ICONS[am] || Shield;
                                            return (
                    ...
                    <div className="lg:col-span-2">
                        <div className="sticky top-28 space-y-4">
                            <GlassCard className="p-6 bg-white shadow-2xl border-gray-100 rounded-3xl">
                                ...
                                {/* Book Button → Opens Glass Drawer */}
                                ...
                                <p className="text-center text-xs text-gray-400 font-medium mt-3">You won't be charged yet. Secure checkout.</p>
                            </GlassCard>
                        </div>
                    </div>
                </div>
            ...
            {/* Glass Checkout Drawer — slides up over this page */}
            <CheckoutDrawer
                isOpen={isDrawerOpen}
