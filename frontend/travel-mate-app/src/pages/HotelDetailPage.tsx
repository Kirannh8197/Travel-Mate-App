//V's_new_start — Premium-Plus: Shared element morphing + Glass Checkout Drawer
...
export const HotelDetailPage = () => {
    ...
    // Open drawer instead of navigating to /payment
    const handleBook = () => {
    ...
    // Booking payload for the drawer
    ...
    return (
        <>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full pb-20 pt-8 max-w-7xl mx-auto px-4 md:px-8">
                ...
                <div className="grid lg:grid-cols-5 gap-10">
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        {/*
                         * layoutId here enables the "grow" morph from the search card.
                         * If no layoutId (direct URL), Framer falls back gracefully.
                         */}
                        <GlassCard
                            className="p-0 overflow-hidden rounded-3xl shadow-2xl border-gray-100"
                        >
                            <motion.div
                                layoutId={hotelLayoutId}
                                className="relative h-80 md:h-[480px] bg-gray-100 group"
                            >
